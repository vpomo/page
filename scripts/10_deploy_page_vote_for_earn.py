from brownie import Contract, PageProxy, PageVoteForEarn
...
def main():
    ...
    pageVote = PageVoteForEarn.deploy({'from': deployer}, publish_source=True)
    ...
    bank.grantRole(bank.VOTE_FOR_EARN_ROLE(), proxyPageVote, {'from': admin})
