...
contract UExecutor is Admin, ASafe {
    ...
    // CREATE NEW
    function createStrategy(string memory _key, address _account)
        public
        onlyOwner
    {
    ...
    // UPDATE ADDRESS
    function updateStrategy(string memory _key, address _account)
        public
        onlyOwner
    {
    ...
    function getStrategy(string memory _key)
        public
        view
        returns (
            uint256 id,
